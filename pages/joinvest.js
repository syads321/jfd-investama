        ...
        <Layout mobile={<Mobile/>}>
            <Banner height={462} multiplier={0}>
                <div className="about-headline">
                    ...
                    <p className="txt-101"><Link href="/"><a className="breadcrumbs active">Home</a></Link>  >>  <Link href="/whatwedo"><a className="breadcrumbs active">What We Do</a></Link> >> Joinvest</p>
                </div>
            </Banner>
